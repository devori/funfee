<script>
    ...
    rates = [
      {
        "future": "AUDIO-PERP",
        "rate": 5e-6,
        "time": "2021-11-13T08:00:00+00:00"
      },
      {
        "future": "SAND-PERP",
        "rate": 0.00003,
      ...
      },
      {
        "future": "SNX-PERP",
        "rate": 0.000012,
        "time": "2021-11-13T07:00:00+00:00"
      },
      {
        "future": "DOT-PERP",
        "rate": -1e-6,
      ...
      },
      {
        "future": "HOLY-PERP",
        "rate": -0.000187,
        "time": "2021-11-13T06:00:00+00:00"
      },
      {
        "future": "ZEC-PERP",
        "rate": 0.000025,
      ...
      },
      {
        "future": "XTZ-PERP",
        "rate": 0.000013,
        "time": "2021-11-13T05:00:00+00:00"
      },
      {
        "future": "LEO-PERP",
        "rate": -6e-6,
  ...
  function sort(field) {
    rates = rates.sort((r1, r2) => ((r1[field] < r2[field]) ? -1 : 1) * (sortAsc ? 1 : -1));
  }
...
>
  ...
  <div class="block w-full overflow-x-auto">
    ...
    <table class="items-center w-full bg-transparent border-collapse">
      ...
      <tbody>
      {#each rates as { future, rate, time }}
        <tr>
          <th
